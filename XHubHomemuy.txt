...
if localVersion ~= version then
    Rayfield:Notify({Title = "HomemuyVis",Content = "Script.Ftap",Duration = 6.5,Image = 4483362458,})
...
local Window = Rayfield:CreateWindow({
    ...
    LoadingTitle = "HomemuyVis Loaded",
    LoadingSubtitle = "by Homemuy",
...
local Paragraph = homeTab:CreateParagraph({Title = "Home!", Content = "Welcome to HomemuyVis! "..Player.Name.." Thanks for useing script!"})

local Label = homeTab:CreateLabel("Homemuy Server / Discord", 10709797725, Color3.fromRGB(10, 10, 10), false) -- Title, Icon, Color, IgnoreTheme
